      ...
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-8 w-auto fill-blue-500" src="@/assets/logo.svg" alt="" style="filter: invert(20%) sepia(95%) saturate(2781%) hue-rotate(240deg) brightness(94%) contrast(91%);">
          </a>
        </div>
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <a href="#" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Hero</a>
